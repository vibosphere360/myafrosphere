...
function createCarouselItem(country) {
    return `<div class="carousel-item" role="listitem" tabindex="0" aria-label="${country.name} flag - ${country.region}" data-country="${country.name}" data-code="${country.code}" data-emoji="${country.emoji}" data-region="${country.region}"><div class="country-flag">${country.emoji}</div><div class="country-name">${country.name}</div></div>`;
}
...
function initializeCarousel() {
    ...
    // Event delegation for carousel items
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelector('.modal-switch a:nth-child(2)').addEventListener('click', e => {
        e.preventDefault();
        closeModal('signinModal');
        openModal('signupModal');
    });
    document.querySelector('.modal-switch a:nth-child(3)').addEventListener('click', e => {
        e.preventDefault();
        closeModal('signupModal');
        openModal('signinModal');
    });
    document.querySelector('.modal-switch a:nth-child(4)').addEventListener('click', e => {
        e.preventDefault();
        closeModal('forgotPasswordModal');
        openModal('signinModal');
    });
    document.querySelector('#signinForm button').addEventListener('click', signIn);
    ...
    document.querySelector('#forgotPasswordForm button').addEventListener('click', resetPassword);
